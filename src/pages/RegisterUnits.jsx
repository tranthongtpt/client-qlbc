...
import {Button,Select,FormControl,InputLabel,TextField,Box} from "@mui/material";
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full">
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            margin="normal"
                            name='provinceId'
                            {...register("provinceId", { required: "Bắt buộc nhập provinceId." })}
                        ...
                        <div className="w-full md:w-1/2 px-3">
                            <InputLabel htmlFor="my-input">typeInstituteId</InputLabel>
                            <TextField 
                            className="appearance-none block w-full text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                            type="text" 
                            variant="outlined"
                            ...
                            {...register("typeInstituteId", { required: "trường này bắt buộc nhập"})}
                            error={Boolean(errors.typeInstituteId)}
                            helperText={errors.typeInstituteId?.message}   
                            />
                        </div>
